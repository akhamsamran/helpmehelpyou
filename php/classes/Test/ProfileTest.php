...
use Edu\Cnm\Helpmehelpyou\Profile;
// grab class
 ...
 **/
class ProfileTest extends HelpmehelpyouTest {
	/**
	 ...
	 **/
	protected $VALID_EMAIL = "akhamsamran1@cnm.edu";
	/**
	 * valid hash to use
	 * @var $VALID_HASH
	 */
	 ...
	 **/
	protected $VALID_USERNAME = "akhamsamran1";
	/**
	...
	public function testGetValidProfileByUsername() {
		...
		$this->assertContainsOnlyInstancesOf("Edu\\CNM\\Helpmehelpyou\\Profile", $results);
	...
	public function testGetInvalidProfileByUsername() : void {
		...
		$profile = Profile::getProfileByProfileUsername($this->getPDO(), "greenmonster12");
