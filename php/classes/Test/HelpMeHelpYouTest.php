 ...
 *
 * This class is designed to lay the foundation of the unit tests for HelpMeHelpYou. It loads all the database
 * parameters about the project so that table specific tests can share the parameters in one place.
 ...
 **/
abstract class HelpMeHelpYouTest extends TestCase {
	use TestCaseTrait;
	/**
	...
	public final function getConnection() : Connection {
		...
		if($this->connection === null) {
			...
			$config = readConfig("/etc/apache2/capstone-mysql/helpmehelpyou.ini");
			$pdo = connectToEncryptedMySQL("/etc/apache2/capstone-mysql/helpmehelpyou.ini");
